 ...
 */
	...
	$.jstree.defaults.core = {
		...
		/**
		 * if left as `true` webSample workers will be used to parse incoming JSON data where possible, so that the UI will not be blocked by large requests. Workers are however about 30% slower. Defaults to `true`
